// this source code using https://github.com/yusukebe/minidon/blob/main/src/utils.ts

export const stob = (s: string) => {
    return Uint8Array.from(s, (c) => c.charCodeAt(0))
}

export const btos = (b: ArrayBuffer) => {
...
export const privateKeyToPublicKey = async (key: CryptoKey) => {
